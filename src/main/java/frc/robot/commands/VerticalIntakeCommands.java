...
public class VerticalIntakeCommands extends Command {
  RobotContainer m_RobotContainer;

  public VerticalIntakeCommands(RobotContainer _RobotContainer) {
  ...
  public void execute() {
    m_RobotContainer.m_SuperStructure.SetMotionMagic(
        SuperStructureConstants.UpperStructureState.VerticalIntake);
