...
public class WristIOKrakenFOC implements WristIO {
    ...
    public void  updateInputs(WristIOInputs inputs){
        ...
        @Override
        public void runPositionSetpoint(double angleRads, double omegaRadPerSec, double alphaRadsPerSecSquared, double torque) {
            wristMotor.setControl(positionControl
