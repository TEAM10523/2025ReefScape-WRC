...
public class kalmanFilter {
    ...
    public kalmanFilter(SwerveDriveKinematics kinematics, Matrix<N3, N1> odometryStateStdDevs, Matrix<N3, N1> processNoisePerUnit){
    ...
    public void updateDrive(Rotation2d gyroYaw, SwerveModulePosition[] modulePositions){
        ...
        odometryStateStdDevs.plus(new Matrix<>(VecBuilder.fill(
