...
public class FieldPoseConversions {
  ...
  public static Pose2d inversePose2dUsingAlliance(
    ...
    if (allianceColor != getAlliance()) {
      return new Pose2d(
          ...
          FieldConstants.filedWidth - pose.getY(),
  ...
  public static Pose2d YFlipPose2d(Pose2d pose) {
    return new Pose2d(
        pose.getX(),
        FieldConstants.filedWidth - pose.getY(),
        new Rotation2d(0).minus(pose.getRotation()));
  }

  public static pairReef inversePairReefUsingAlliance(
      pairReef pairReef, DriverStation.Alliance allianceColor) {
