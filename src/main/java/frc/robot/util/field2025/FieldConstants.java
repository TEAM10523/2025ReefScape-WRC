...
public class FieldConstants {
    ...
    public static final pairReef reefBack = new pairReef(
        new Pose2d(3.180, 4.0235, new Rotation2d(0)), new Pose2d[]{reefBlueB, reefBlueA}, 2);
    public static final pairReef reefBackRight = new pairReef(
        new Pose2d(3.823, 2.881, new Rotation2d(1.0471975)), new Pose2d[]{reefBlueD, reefBlueC}, 3);
    public static final pairReef reefFrontRight = new pairReef(
        new Pose2d(5.154, 2.8735, new Rotation2d(2.09439)), new Pose2d[]{reefBlueE, reefBlueF}, 2);
    public static final pairReef reefFront = new pairReef(
        new Pose2d(5.815, 4.0265, new Rotation2d(3.1415926)), new Pose2d[]{reefBlueG, reefBlueH}, 3);
    public static final pairReef reefFrontLeft = new pairReef(
        new Pose2d(5.158, 5.1825, new Rotation2d(-2.09439)), new Pose2d[]{reefBlueI, reefBlueJ}, 2);
    public static final pairReef reefBackLeft = new pairReef(
        new Pose2d(3.824, 5.171, new Rotation2d(-1.0471975)), new Pose2d[]{reefBlueL, reefBlueK}, 3);

    public static final pairReef[] pairReefs = new pairReef[]{
        reefBack,
        reefBackRight,
        reefFrontRight,
        reefFront,
